...
class ButtonTagsWidget(ctk.CTkFrame):
    ...
    def _apply_filter(self):
        ...
        self._values = filtered or list(BUTTON_TAGS)
    ...
    def _open_dropdown(self):
        ...
        # 3) conteúdo com borda e fundo claro/escuro (aqui pode usar pack à vontade)
        ...
        # 4) popula a lista e dá foco ao popup
        self._fill_dropdown(self._values)
    ...
    def _fill_dropdown(self, values):
        ...
        # Itens flat (texto clicável), compactos e legíveis
        for v in values:
            btn = ctk.CTkButton(
                self._scroll,
                text=v,
                ...
                text_color=("black", "white"),   # texto PRETO no claro, BRANCO no escuro
                hover=False,
                border_width=0,
                corner_radius=0,
...
# (lista encurtada no exemplo; mantenha a sua completa)
BUTTON_TAGS = [
    "back_return","channel_down","channel_enter","channel_last","channel_next","channel_prev","channel_up",
    "cursor_down","cursor_left","cursor_ok_select","cursor_right","cursor_up","digit_0","digit_1","digit_100",
    "digit_2","digit_3","digit_4","digit_5","digit_6","digit_7","digit_8","digit_9","digit_dash","disneyplus",
    "display","display_dimmer","exit_cancel","favorite","format_wide","func_blue","func_green","func_red",
    "func_yellow","globoplay","google","guide","home","info","input_audio","input_audio_1","input_audio_2",
    "input_audio_3","input_aux","input_av1","input_av2","input_av3","input_av4","input_av5","input_av6","input_bd",
    "input_bt","input_cd","input_cdr_tape","input_comp1","input_comp2","input_comp3","input_dock","input_down",
    "input_dvd","input_game","input_game2","input_hdmi_1","input_hdmi_2","input_hdmi_3","input_hdmi_4","input_hdmi_5",
    "input_media_player","input_mhl","input_movie","input_music","input_net","input_phono","input_photo",
    "input_rgb_pc","input_sat_cbl","input_scroll","input_tuner","input_tv","input_up","input_usb","input_vcr",
    "internet","menu","menu_3d","menu_disc","menu_popup","menu_position","menu_system","menu_top","microphone","mode",
    "movie","music","mute","netflix","next","now","open_close_eject","osd","page_down","page_up","photo","picture",
    "pip_channel_down","pip_channel_up","pip_freeze","pip_input","pip_move","pip_multi","pip_off","pip_on","pip_swap",
    "play","portal","power_off_discr","power_on_discr","power_on_off","preset_minus","preset_plus",
    "preset_quickselect_1","preset_quickselect_2","preset_quickselect_3","preset_quickselect_4",
    "preset_quickselect_5","preset_quickselect_6","preset_quickselect_7","prev","primevideo","radio","repeat","reset",
    "restorer","return","ripping","sap","search","setup_function","shift","sleep","slow","smart","sound_edit","source",
    "status","step","subtitle","surround_down","surround_on_off","surround_up","time","title","tone"
]
